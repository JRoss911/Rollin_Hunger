...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FOODTRUCK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FOODTRUCK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FOODTRUCK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FOODTRUCK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FOODTRUCK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FOODTRUCK actions', async () => {
      const arg = 42666;
