...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './menu-item.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MENUITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MENUITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MENUITEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MENUITEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MENUITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MENUITEM actions', async () => {
      const arg = 42666;
