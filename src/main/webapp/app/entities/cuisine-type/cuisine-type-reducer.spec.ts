...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUISINETYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CUISINETYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CUISINETYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CUISINETYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CUISINETYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CUISINETYPE actions', async () => {
      const arg = 42666;
