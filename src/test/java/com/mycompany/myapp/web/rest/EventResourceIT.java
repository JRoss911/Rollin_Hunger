...
class EventResourceIT {
    ...
    public static Event createEntity(EntityManager em) {
        Event event = new Event().name(DEFAULT_NAME).date(DEFAULT_DATE).description(DEFAULT_DESCRIPTION);
        return event;
    }
    ...
    public static Event createUpdatedEntity(EntityManager em) {
        Event event = new Event().name(UPDATED_NAME).date(UPDATED_DATE).description(UPDATED_DESCRIPTION);
        return event;
    }
    ...
    void putExistingEvent() throws Exception {
        ...
        updatedEvent.name(UPDATED_NAME).date(UPDATED_DATE).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateEventWithPatch() throws Exception {
        ...
        partialUpdatedEvent.name(UPDATED_NAME).date(UPDATED_DATE).description(UPDATED_DESCRIPTION);
